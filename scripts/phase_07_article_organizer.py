...
def main():
    ...
    parser = argparse.ArgumentParser(description="Auto-organize articles from intake folder")
    parser.add_argument("--dry-run", action="store_true", help="Show what would be done without making changes")
    parser.add_argument("--watch", action="store_true", help="Watch intake folder for new files")
