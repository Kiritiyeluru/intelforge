...
class ChromaVectorStorage:
    ...
    def __init__(
        ...
        collection_name: str = "semantic_capture",
    ):
        ...
        try:
            ...
            if source_dir.exists():
                ...
                raise FileNotFoundError(
                    f"Source directory not found: {self.persist_directory}"
                )
    ...
    def restore_snapshot(self, snapshot_path: str) -> bool:
        ...
        try:
            ...
            print("✅ ChromaDB snapshot restored successfully")
            return True
        ...
        try:
            ...
            try:
                ...
                if response and response[0]:
                    ...
                    print(
                        f"✅ Successfully migrated {len(chroma_points)} points from Qdrant to ChromaDB"
                    )
                    return True
                else:
...
def migrate_qdrant_to_chroma(
    qdrant_path: str = "./qdrant_storage", chroma_path: str = "./chroma_storage"
) -> bool:
