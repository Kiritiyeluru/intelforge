    ...
    try:
        ...
        try:
            ...
            if driver.is_element_present('meta[name="description"]'):
                result['meta_description'] = driver.get_attribute('meta[name="description"]', 'content')
                
            # Try to get meta keywords  
            if driver.is_element_present('meta[name="keywords"]'):
                result['meta_keywords'] = driver.get_attribute('meta[name="keywords"]', 'content')
        except:
            pass
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Stealth Scraper - Advanced Anti-Detection Web Scraping")
    ...
    print(f"Stealth Scraper - Botasaurus Framework")
    ...
    try:
        ...
        for result in results:
            ...
            if result.get('bot_detected'):
                bot_detections += 1
                print(f"   ⚠️  Bot detection warning")
            else:
        ...
        # Summary
        print(f"\n{'='*50}")
        print(f"📊 Stealth Scraping Summary:")
        ...
        print(f"   Framework: Botasaurus (undetectable)")
