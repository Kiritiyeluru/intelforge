...
class LLMContentScorer:
    ...
    def _initialize_ai_clients(self):
        ...
        try:
            ...
            claude_key = (
                self.config.get('ai', {}).get('claude', {}).get('api_key') or
...
"""
    ...
    def _score_with_local_heuristics(self, content: str, criteria: List[str]) -> Dict[str, Any]:
        ...
        keyword_weights = {
            ...
            'technical_analysis': ['indicator', 'rsi', 'macd', 'bollinger', 'moving average'],
            ...
            'market_insights': ['market', 'trend', 'analysis', 'insight', 'observation']
        }
    ...
    def batch_score_directory(self, directory: Path, criteria: List[str], 
...
def main():
    ...
    filtered_results = [
        r for r in results 
        if r.get('overall_score', 0) >= args.threshold
    ]
