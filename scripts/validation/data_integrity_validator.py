...
class DataIntegrityValidator:
    ...
    def validate_embedding_count(self) -> IntegrityCheckResult:
        ...
        try:
            ...
            counts_match = (
                embeddings_count == metadatas_count == 
                documents_count == ids_count
            )
    ...
    def validate_vector_dimensions(self, expected_dim: int = 384) -> IntegrityCheckResult:
    ...
    def validate_vector_dtype(self, expected_dtype: str = "float32") -> IntegrityCheckResult:
    ...
    def run_comprehensive_integrity_check(self) -> Dict[str, IntegrityCheckResult]:
        ...
        logger.info(f"Integrity check completed: {passed_checks}/{total_checks} checks passed")
