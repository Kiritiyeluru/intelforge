...
class TradingStrategyExtractor:
    ...
    def analyze_trading_strategies(self, category_filter: str = None) -> Dict[str, Any]:
            ...
            for concept_type, concepts in extracted.items():
                if concepts:
                    strategy_entry = {
                        ...
                        'concepts': concepts,
                        'chunk_similarity_potential': len(concepts)  # Rough relevance score
                    }
        ...
        strategy_database['summary'] = {
            ...
            'categories_found': list(set(chunk['category'] for chunk in self.ai_processor.chunks_metadata))
        }
...
def main():
    ...
    if args.build:
        ...
        if 'error' in analysis:
            ...
            print(f"📊 Trading Strategy Analysis Complete")
            ...
            print(f"   Performance Metrics: {analysis['summary']['total_performance_metrics']}")
