...
class TestSentenceTransformers:
    ...
    def test_model_loading(self):
        ...
        try:
            ...
            self.validator._log_test_result(
                "sentence_transformers", "model_loading", False, {"error": str(e)}
            )
    ...
    def test_embedding_consistency(self):
        ...
        try:
            ...
            for i, embedding in enumerate(embeddings[1:], 1):
                ...
                assert (
                    similarity > 0.999
                ), f"Consistency check failed at run {i}: {similarity}"

            # Check for deterministic behavior
            max_diff = max(
                np.max(np.abs(base_embedding - emb)) for emb in embeddings[1:]
            )
            assert (
                max_diff < 1e-6
...
class TestChromaDB:
    ...
    def test_client_creation(self):
        ...
        try:
            ...
            self.validator._log_test_result(
                "chromadb", "client_creation", True, {"temp_dir": self.temp_dir}
            )

        except Exception as e:
            self.validator._log_test_result(
                "chromadb", "client_creation", False, {"error": str(e)}
            )
    ...
    def test_collection_operations(self):
        ...
        try:
            ...
            self.validator._log_test_result(
                "chromadb", "collection_operations", False, {"error": str(e)}
            )
    ...
    def test_document_operations(self):
        ...
        try:
            ...
            query_results = collection.query(query_texts=["test document"], n_results=2)
            ...
            self.validator._log_test_result(
                "chromadb", "document_operations", False, {"error": str(e)}
            )
    ...
    def test_custom_embeddings(self):
        ...
        try:
            ...
            self.validator._log_test_result(
                "chromadb", "custom_embeddings", False, {"error": str(e)}
            )
...
class TestQdrant:
    ...
    def test_qdrant_client_creation(self):
        ...
        try:
            ...
            self.validator._log_test_result(
                "qdrant", "client_creation", False, {"error": str(e)}
            )
...
class TestMLIntegration:
    ...
    def test_end_to_end_semantic_search(self):
        ...
        try:
            ...
            collection.add(
                ...
                ids=ids,
                metadatas=[
                    {"topic": f"topic_{i}", "length": len(doc)}
            ...
            self.validator._log_test_result(
                "ml_integration", "end_to_end_semantic_search", False, {"error": str(e)}
            )
    ...
    def test_ml_component_health_check(self):
        ...
        self.validator._log_test_result(
            "ml_integration", "health_check", True, health_status
        )
...
def generate_ml_test_report(output_dir: str = "logs/ml_testing"):
    ...
    report_file = os.path.join(
        output_dir,
        f"ml_component_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json",
    )
...
if __name__ == "__main__":
    ...
    if SENTENCE_TRANSFORMERS_AVAILABLE and CHROMADB_AVAILABLE:
        ...
        try:
            ...
            collection.add(documents=[test_doc], embeddings=embedding, ids=["test_doc"])
