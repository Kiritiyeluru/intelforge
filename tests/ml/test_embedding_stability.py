...
class EmbeddingStabilityValidator:
    ...
    def test_dimensional_consistency(self) -> bool:
        ...
        try:
            ...
            consistency_passed = len(unique_dimensions) == 1 and list(unique_dimensions)[0] == self.expected_dimension
            
            self.stability_results.append(EmbeddingStabilityResult(
    ...
    def test_reproducibility(self, num_runs: int = 5) -> bool:
        ...
        test_text = "This is a test for embedding reproducibility and deterministic behavior."
    ...
    def test_magnitude_stability(self) -> bool:
        ...
        try:
            ...
            for group in test_groups:
                ...
                magnitudes = [self._compute_embedding_magnitude(emb) for emb in embeddings]
                
                # Compute magnitude ratios
                for i in range(len(magnitudes)):
                    for j in range(i + 1, len(magnitudes)):
                        ratio = max(magnitudes[i], magnitudes[j]) / min(magnitudes[i], magnitudes[j])
    ...
    def test_semantic_stability(self) -> bool:
        ...
        try:
            ...
            self.stability_results.append(EmbeddingStabilityResult(
                ...
                consistency_score=min_similar / max_different if max_different > 0 else 0.0,
    ...
    def generate_stability_report(self, output_dir: str = "logs/ml_testing") -> str:
        ...
        report_file = os.path.join(output_dir, f"embedding_stability_report_{timestamp}.json")
...
class TestVectorStoreConsistency:
    ...
    def test_embedding_consistency_across_storage(self):
        ...
        # Test document
        test_doc = "This document tests embedding consistency across storage operations."
