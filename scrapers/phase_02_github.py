...
def fetch_github_repos(config, dry_run=False):
    ...
    try:
        ...
        logging.info(f"Starting GitHub fetch: query='{query}', max_results={max_results}")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="GitHub repository mining for IntelForge")
    ...
    # Setup logging
    log_file = config["paths"]["log_file"].replace("github_fetch.log", "phase_02_github.log")
