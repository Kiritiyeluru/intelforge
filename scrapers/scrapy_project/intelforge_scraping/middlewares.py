...
class StealthDownloaderMiddleware:
    ...
    def process_request(self, request, spider):
        ...
        try:
            ...
            spider.logger.info(f"Stealth request successful: {request.url} (Status: {response.status_code})")
    ...
    def process_exception(self, request, exception, spider):
        ...
        spider.logger.error(f"Stealth middleware exception for {request.url}: {exception}")
        return None
...
class NoDriverMiddleware:
    ...
    def __init__(self, nodriver_enabled=False):
        ...
        if self.nodriver_enabled:
            try:
                ...
                self.logger.warning("NoDriver not available - install with: pip install nodriver")
    ...
    def process_exception(self, request, exception, spider):
        ...
        spider.logger.error(f"NoDriver middleware exception for {request.url}: {exception}")
        return None
